...
import { TextField, Grid, Typography, Container, Button, Icon, Modal, DialogActions } from '@material-ui/core'
 ...
 const [open, setOpen] = React.useState(false);
  ...
  const handleClose = () => {
    ...
    <Container component="main" maxWidth="md" className={classes.container}>
      <Typography
              component="h5" variant="h5" className={classes.assignments}>
              {course && course.name}
        </Typography>
     ...
     <Grid item xs={12} sm={6}>
       <TextField
        ...
        <TextField
              ...
              </Grid> </div> ))}  <div className={classes.buttonStyle}>  <Button
        variant="contained"
        color="primary"
